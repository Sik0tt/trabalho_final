            ...
            <table class="table table-striped" >
                ...
                <tbody>
                    <tr v-for="(f, indice) in funcionarios" :key ="f.cpf" :class="{ active: indice == currentIndex }">
                            ...
                            <td>{{f.ctps}}</td>
                            <td>{{f.senha}}</td>                                  
                            <td><button v-on:click="setCurrentFuncionario(j, indice)" class="btn" type="button">Alterar</button></td>
                            <td><button v-on:click="remFuncionario(j, indice)" class="btn" type="button">Remover</button></td>
                    </tr>
                </tbody>
            </table>
