    ...
    <div class="submit-form">
      <div v-if="!submitted">       
        ...
        <div class="form-group">
            ...
            <select v-model="pet.racas" class="form-control" id="selectRaca" multiple>                                
    ...
    export default {
        ...
        methods: {
            ...
            savePet(){
                ...
                var pet = jQuery.extend({}, this.pet);//clona o this.novo_equipamento e armazena na variavel equipamento. dessa forma alteracoes em this.novo_equipamento nao irao refletir em equipamento.
                var raca = jQuery.extend({}, this.pet.racas);//clona o this.novo_equipamento.peca                        
                pet.racas.id = raca;                                                
