    ...
    <div id="tab_aut">
        ...
        <div class="col-md-6">
            ...
            <table class="table table-striped" >
                ...
                <tbody>
                    <tr v-for="(v, indice) in vendas" :key ="v.id" :class="{ active: indice == currentIndex }">
                            <td>{{v.id}}</td>
                            <td>{{v.observacao}}</td>
                            <td>{{v.valor_total}}</td>
                            <td>{{v.data_compra | formataData}}</td>
               
                            <td><button v-on:click="setCurrentServico(v, indice)" class="btn" type="button">Alterar</button></td>
